...
<div class="mermaid">
flowchart LR
  subgraph CRE["CRE<sub>(Promoter / Enhancer)</sub>"]
    TFBS["TFBS"]
  end
  subgraph DNA["DNA"]
    Gene["Gene"]
  ...
  TF["TF<sub>(Activator / Repressor)</sub>"] L_TF_TFBS_0@-- binds to --> TFBS
  CRE -- regulates<br>expression --> Gene
  
  L_TF_TFBS_0@{ animation: slow } 
</div>
